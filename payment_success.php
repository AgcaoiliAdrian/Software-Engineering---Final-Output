...
if(isset($_POST['submit'])){
	...
	mysqli_query($con,"insert into `order`(user_id,address,city,pincode,user_name,contact,payment_type,payment_status,order_status,added_on,total_price,coupon_id,coupon_code,coupon_value) values('$user_id','$address','$city','$pincode','$user_name','$contact','PayPal','$payment_status','$order_status','$added_on','$total_price','$coupon_id','$coupon_code','$coupon_value')");
                    ...
                    <div class="col-md-8">
                        <div class="checkout__inner">
                            <div class="accordion-list">
                                <div class="accordion">
									<div class="pay">
										Your PayPal payment has been placed! Fill out and submit the form to confirm your order.
									</div>
									<?php 
                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            ...
                            <div class="ordre-details__total">
                                <h5>Order total</h5>
                                <span class="price" id="order_total_price"><p>&#8369</p> <?php echo $cart_total?></span>
                            </div>
                        </div>
                    </div>
                </div>
