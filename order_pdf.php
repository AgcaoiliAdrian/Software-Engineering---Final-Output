...
$html='<div class="wishlist-table table-responsive">
   <table>
      ...
      <tbody>';
		...
		$total_payment=$total_price+$row['fee'];
		 $pp=$row['qty']*$row['price'];
         $html.='<tr>
            <td class="product-name">'.$row['name'].'</td>
            <td class="product-name"> <img src="'."./product/".$row['image'].'" style="width: 130px"></td>
		 ...
		 $html.='<tr>
				...
				<td class="product-name">₱ '.$total_payment.'</td>
