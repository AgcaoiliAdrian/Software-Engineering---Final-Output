                        ...
                        <div class="wishlist-table table-responsive">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td class="product-add-to-cart"><a href="my_order_details.php?id=<?php echo $row['id']?>"><?php $row['id']?>View</a>
                                        <br/>
                                        <a href="cancel_order.php?id<?php echo $row['id']?>"><?php $row['id']?>Cancel</a>
                                        </td>
