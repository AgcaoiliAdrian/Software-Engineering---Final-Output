...
if(isset($_POST['submit'])){
	...
	$user_name=get_safe_value($con,$_POST['username']);
	...
	mysqli_query($con,"insert into `order`(user_id,address,city,pincode,user_name,contact,payment_type,total_price,payment_status,order_status,added_on) values('$user_id','$address','$city','$pincode','$user_name','$contact','$payment_type','$shipping','$payment_status','$order_status','$added_on')");
	...
	foreach($_SESSION['cart'] as $key=>$val){
		...
		$price=$productArr[0]['price'];
		$qty=$val['qty'];
		// $total_pay=$price+$delivery;
		mysqli_query($con,"insert into `order_detail`(order_id,product_id,qty,price,fee) values('$order_id','$key','$qty','$price','$delivery')");
	}
									...
									<div class="<?php echo $accordion_class?>">
										...
										<div class="accordion__body">
											...
											<div class="payment_paypal">
												<?php include './payment/paypal.php'; ?>
											</div>
										</div>
									...
									<div class="accordion__body">
											<div class="bilinfo">
													<div class="row">
														<div class="col-md-6">
															<div class="single-input">
																<input type="text" name="username" placeholder="Full name" required value="<?php echo $_SESSION['USER_NAME']?>">
															</div>
														</div>
														<div class="col-md-6">
															<div class="single-input">
                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            ...
                            <div class="order-details__item">
								...
								<div class="single-item">
                                    ...
                                    <div class="single-item__content">
                                        ...
                                        <span class="price"><p>&#8369</p> <?php echo $price*$qty?></span>
                                    </div>
							...
							<div class="ordre-details__total">
                                <h5>Delivery Fee</h5>
                                <span class="price" id="order_total_price"><p>&#8369</p> <?php echo $delivery?></span>
                            </div>
							<div class="ordre-details__total">
                                <h5>Order total</h5>
                                <span class="price" id="order_total_price"><p>&#8369</p> <?php echo $shipping?></span>
                            </div>
                        </div>
                    </div>
                </div>
